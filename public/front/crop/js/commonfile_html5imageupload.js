...
(function (window, $, undefined) {
    ...
    $.html5imageupload = function html5imageupload(options, element) {
        ...
        this.button.edit = '<div class="btn btn-info btn-edit"><i class="fa fa-pencil"></i></div>'

        this.button.saving = '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="fa fa-clock-o"></i></div>';

        this.button.zoomin = '<div class="btn btn-default btn-zoom-in"><i class="fa fa-search-plus"></i></div>';

        this.button.zoomout = '<div class="btn btn-default btn-zoom-out"><i class="fa fa-search-minus"></i></div>';

        this.button.zoomreset = '<div class="btn btn-default btn-zoom-reset"><i class="fa fa-arrows-alt"></i></div>';

        this.button.cancel = '<div class="btn btn-danger btn-cancel"><i class="fa fa-times"></i></div>';

        this.button.done = '<div class="btn btn-success btn-ok"><i class="fa fa-check"></i></div>';

        this.button.del = '<div class="btn btn-danger btn-del"><i class="fa fa-trash"></i></div>';
