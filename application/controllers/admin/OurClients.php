...
class OurClients extends BaseController
{
    public function __construct()
    {
        ...
        $this->id = "id";  
        $this->MainTitle = "Our Clients";
        $this->folder = "our_clients/"; 
        $this->Controller = "OurClients"; 
        $this->url = "our_clients";
        $this->img_path = IMG_CLIENT; 
