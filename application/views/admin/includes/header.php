            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-bars"></i> <span>Newsletter</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo ADMIN_LINK; ?>newsletter"><i class="fa fa-circle-o"></i>Manage Newsletter</a></li>
                            </ul>
                        </li>

                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-bars"></i> <span>FAQ</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo ADMIN_LINK; ?>faq"><i class="fa fa-circle-o"></i>Manage FAQ</a></li>
