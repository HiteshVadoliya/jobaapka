                ...
                <div class="box box-primary">
                    ...
                    <?php } ?>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($edit) && $edit['title']!='' ) { echo $edit['title']; } else { set_value('fname'); } ?>" id="title" name="title" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required datepicker" value="<?php if(isset($edit) && $edit['date']!='' ) { echo $edit['date']; } else { set_value('fname'); } ?>" id="date" name="date" >
                                    </div>
                            ...
                            <span>Image size should be for best result :500 * 350 </span>
                        </div><!-- /.box-body -->
