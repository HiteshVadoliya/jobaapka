...
<!-- Candidate Dashboard Area End -->
 ...
 <script type="text/javascript">
    ...
    $(".get_history").on("click", function(){
      ...
      $.ajax({
            url: "<?php echo base_url()."JobSeeker_Process/get_history_edu/" ?>",
            method: "POST",
            dataType: "json",
            data :{eid:eid},
    ...
    $("#frm_history").on('submit',function(){
        ...
        $.ajax({
            type: "POST",            
            url: "<?php echo base_url('JobSeeker_Process/history_edu') ?>",
           ...
           dataType: "json",
            success: function(res) {
               ...
               var url = '<?php echo base_url('jobseeker/education'); ?>';
               window.location = url;
            },
    ...
    $(".del_his").on("click", function(){
      ...
      $.ajax({
            url: "<?php echo base_url()."JobSeeker_Process/delete_history_edu/" ?>",
            method: "POST",
            dataType: "json",
            data :{jobid:did},
            success: function(data) {
