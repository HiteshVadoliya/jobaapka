...
<!-- Breadcromb Area Start -->
      ...
      <section class="jobguru-browse-company-area section_70">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                <center><h4>WE OFFER <u>UNLIMITED</u> JOB POSTINGS AND <u>UNLIMITED</u> CV DOWNLOADS FOR <u>COMPLETE 6 MONTHS</u></h4></center>
                     ...
                     <div class="tab-pane fade show active" id="company_a" role="tabpanel" aria-labelledby="company_a_tab">
                        <div class="row">                           
                           <div class="col-lg-4 col-md-12  companyBox moreBox">
                              <div class="single-browse-company">                                 
                                 <h3>
                                 <a href="<?= base_url('signup/jobseeker'); ?>" class="post-jobs">GROW YOUR BUSINESS WITH US</a>
                                 </h3>
                              </div>
                           </div>
