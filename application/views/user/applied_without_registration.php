         ...
         <div class="row">
            <div class="col-md-12">
               <div class="breadcromb-box">
                  <h3>Applied without Registration</h3>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-12">
               <div class="breadcromb-box-pagin">
                  <ul>
                     ...
                     <li class="active-breadcromb"><a href="javascript:;">Applied without Registration</a></li>
                  </ul>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   function get_data(pagno) {
      ...
      var url = "<?php echo base_url()."Employer_Process/get_result_without_registration/" ?>" +pagno;
      if(job_view_id) {
        var url = "<?php echo base_url()."Employer_Process/get_result_jobseeker_list_without_registration/" ?>" +pagno;
      }
